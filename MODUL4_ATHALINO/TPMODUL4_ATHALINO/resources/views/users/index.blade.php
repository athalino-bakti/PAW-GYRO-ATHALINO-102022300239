            ...
            <tr style="background-color: #fff; border-bottom: 1px solid #ddd;">
                ...
                <td style="padding: 12px;">
                    ...
                    <form action="{{ route('users.destroy', $user->id) }}" method="POST" style="display:inline;">
                        @csrf @method('DELETE')
                        <button type="submit" style="padding: 8px 16px; font-size: 14px; border-radius: 5px; background-color: #f44336; color: white; border: none; cursor: pointer; text-decoration: none; transition: background-color 0.3s ease;" onclick="return confirm('apakah yakin untuk menghapus')">Hapus</button>
                    </form>
                </td>
            </tr>
        @endforeach
