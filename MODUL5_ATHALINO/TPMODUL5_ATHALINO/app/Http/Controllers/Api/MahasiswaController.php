 ...
 public function store(Request $request)
{
    ...
    if (!$request->hasFile('foto_profil') || !$request->file('foto_profil')->isValid()) {
        return response()->json(['error' => 'File foto_profil tidak valid atau tidak ditemukan'], 400);
    }
    ...
    public function destroy($id)
    {
        ...
        Storage::disk('public')->delete('foto_profil/' . $mahasiswa->getRawOriginal('foto_profil'));
